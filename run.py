...
from exp.exp_reconstruct import Exp_Reconstruct
from exp.exp_contrastive import Exp_Contrastive
import random
import numpy as np
...
if __name__ == '__main__':
    ...
    # basic config
    parser.add_argument('--task_name', type=str, default='reconstruct',
    ...
    # data loader
    parser.add_argument('--data', type=str,  default='SW', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./data', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='bmw_stud_welding_gun_v2_wholedataset.csv', help='data file')
    ...
    parser.add_argument('--checkpoints', type=str, default='./pretrain/', help='location of model checkpoints')
    ...
    if args.task_name == 'long_term_forecast':
        ...
        Exp = Exp_Rul
    elif args.task_name == 'reconstruct':
        Exp = Exp_Reconstruct
    elif args.task_name == 'contrast':
        Exp = Exp_Contrastive
    else:
        Exp = Exp_Long_Term_Forecast
